...
**Kafa sending messages from producer to consumer with consoles via Kafka Broker (in Docker):**
![Kafka with Console](https://www.tutorialkart.com/wp-content/uploads/2017/11/apache-kafka-console-producer-consumer.png)
**Kafka sending messages from producer to consumer with java files via Kafka Broker (in Docker):**
![Kafka with Java](https://media.geeksforgeeks.org/wp-content/uploads/20220214105957/SpringBootProducerConsumer.jpg)
### Requirements
...
# How to open JAVA Projects in IntellJ:
**--> file --> new --> project from existing sources--> choose whole file zou want to import as project --> import project from external model --> select Maven**

open java file (with double-click) and exejute file (green run arrow-button)
### Java Example
